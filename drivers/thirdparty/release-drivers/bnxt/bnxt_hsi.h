...
struct hwrm_async_event_cmpl_dbg_buf_producer {
	...
	#define ASYNC_EVENT_CMPL_DBG_BUF_PRODUCER_EVENT_DATA1_TYPE_LAST            ASYNC_EVENT_CMPL_DBG_BUF_PRODUCER_EVENT_DATA1_TYPE_ROCE_HWRM_TRACE
};
...
struct hwrm_dbg_log_buffer_flush_input {
	...
	#define DBG_LOG_BUFFER_FLUSH_REQ_TYPE_LAST           DBG_LOG_BUFFER_FLUSH_REQ_TYPE_ROCE_HWRM_TRACE
	u8	unused_1[2];
	__le32	flags;
